...
if( $other['category'] == 'yes' ){
	add_action( 'load-themes.php',  'sa_no_category_base_refresh_rules');
	add_action('created_category', 'sa_no_category_base_refresh_rules');
	add_action('edited_category', 'sa_no_category_base_refresh_rules');
	add_action('delete_category', 'sa_no_category_base_refresh_rules');
}
if( $sitemap['auto'] == 'yes' ){
